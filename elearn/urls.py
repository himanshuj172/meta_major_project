...
urlpatterns = [
    ...
    # Instructor URLs
    path('instructor/', views.home_instructor, name='home_instructor'),
    path('add_quiz/', views.QuizCreateView.as_view(), name='add_quiz'),
    path('quiz_change/<int:pk>/', views.QuizUpdateView.as_view(), name='quiz_change'),
